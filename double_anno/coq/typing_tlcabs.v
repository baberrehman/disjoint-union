...
Lemma expr_inf_typ : forall G e A e',
typing G e check A -> e --> e' ->
...
Proof.
  ...
  - inverts* He2.
   + inverts* H. inverts* H0. inverts* H4.
     ...
     apply H3 in H0. inversion H0.
     inversion H6.
   + inverts Typ. eapply expr_inf_typ in H8; eauto.
     destruct H8 as [S [H0']].
  ...
  - inverts* He2.
   + inverts Typ.
     eapply expr_inf_typ in H7; eauto.
