...
specialize (H0 A A).
forwards*: H0. admit.
specialize (H0 A A). forwards*: H0. admit.
destruct IHbottomlike.
left.
...
Definition btmLikeSpec C := (forall A B, 
...
- destruct IHbottomlike1; destruct IHbottomlike2; eauto.
  + left. intros.
    ...
    split.
  admit.
  apply sub_or in H5. destruct H5. auto.
  + left. intros.
    apply H1.
    unfold Isomorphic in *. split.
    destruct H3. admit.
    destruct H3.
    apply sub_or in H4. destruct H4. auto.
  + left. intros. apply H2.
    unfold Isomorphic in *. destruct H3. split.
    admit.
    apply sub_or in H4. destruct H4. auto.
- right. eapply bl_anda with (B:=B) in H.
; eauto.
...
- destruct H1. dependent induction H1; eauto.
  ...
  specialize (IHsubtyping A B).
  apply bl_anda. admit. admit.
- destruct H1. dependent induction H2; eauto.
  apply sub_or in H1. destruct H1; eauto. admit. admit.
- admit.
- admit.
Admitted.     
