...
(*
This file is created on March 06, 2021
...
Inductive step : exp -> exp -> Prop :=    (* defn step *)
 ...
 | step_beta : forall (e:exp) (A1 B1 A2 B2:typ) (v v1:exp) (C:typ),
     lc_exp (e_abs e) ->
     value v ->
     dropanno v v1 ->
...
(*case step-beta*)
  - inverts* He2.
    ...
    * inverts H6.
     assert (wexpr (e_ann (e_lit i5) A0)) by auto. contradiction.
    * inverts H6. assert (wexpr (e_ann (e_bool b) A0)) by auto. contradiction.
    * inverts H6. assert (wexpr (e_ann (e_str s) A0)) by auto. contradiction.
    * inverts H6. assert (wexpr (e_ann (e_ann (e_abs e0) (t_arrow A3 B)) A0)) by auto.
      contradiction.
      inversion H8.
    * inversion H6.
