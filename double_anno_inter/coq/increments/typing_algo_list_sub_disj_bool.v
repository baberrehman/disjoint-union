...
Require Import syntax_algo_list_sub_disj_bool.

(*
This file is created on February 24, 2021

syntax_algo_list_sub_disj_bool.v is the syntax file for this semantics
...
inductions Typ; intros EQ; subst.
 ...
 - destruct* IHTyp1.
   ...
   * inverts* H.
    inverts* H1. 
    inverts Typ1. inverts H2. inverts H. inversion H1.
    inverts H.
    inverts Typ1. inverts H2. inverts H. inversion H1.
    inverts H.
    inverts Typ1.
...
Proof.
  ...
  - inverts* He2.
    ...
    * inverts* He1. unfold not in H2.
      assert (value (e_ann (e_bool b) A0)). auto.
      apply H2 in H0. inversion H0.
