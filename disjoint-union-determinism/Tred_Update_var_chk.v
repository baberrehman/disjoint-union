...
Proof.
  intros.
  inductions H.
  apply typing_var; eauto. admit.
  apply (@typing_sub S). auto.
  apply (@sub_transitivity T S B); auto.
  apply typing_typeof with (L:=L); auto.
Admitted.

Lemma anno_inv1 : forall E e A B dir, typing E (trm_anno e A) dir B ->
                                   typing E e chk B.
Proof.
intros E e A B dir H1.
dependent destruction H1.
...
inductions H0. inversion H; subst.
inversion H2; subst.
...
Lemma typing_through_subst_ee_chk : forall E F x T e u dir U,
...
Lemma typing_through_subst_ee_inf : forall E F x T e u dir U,
   typing (E & x ~: U & F) e dir T ->
   typing E u inf U ->
   value u ->
   typing (E & F) (subst_ee x u e) dir T.
...
Proof.
  ...
  - dependent destruction Red.
   + forwards * : IHTyp1.
    eapply typing_app with (T1 := T1); auto.
   ...
   rewrite concat_empty_r. reflexivity.
   rewrite H5.
   eapply typing_through_subst_ee_chk; eauto.
   - forwards * : IHTyp.
    eapply typing_sub; eauto.
  - dependent destruction Red.
   + forwards * : IHTyp.
...
Proof.
  ...
  - right. destruct* IHTyp.
    + apply typ_red_val_dir in Typ; auto.
      exists e1. apply red_annov; auto.
