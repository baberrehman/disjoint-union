...
Proof.
  ...
  lets H1': H1.
  inverts H1.
  apply ord_sub_or_unique in H2; auto.
...
- inverts Typ. inverts H0. inverts H4. inverts H0.
  ...
  eapply typ_sub; eauto. eapply DS_trans; eauto.
Qed.
  ...
  - (* app *)
    ...
    + (* beta *)
      ...
      *
        ...
        apply arrow_inv in H0. 
        destruct H0.
        apply dsub2asub in H0.
        apply dsub2asub in H2.
        constructor.
        pick_fresh x.
        assert (x \notin L) by auto.
        lets: H x H4.
...
inductions Typ; intros EQ; subst.
 ...
 - destruct* IHTyp1.
  + destruct* IHTyp2.
   * inverts* H. inverts H1. inverts Typ1. inverts H2.
     inverts H.
     apply int_sub_arrow_false in H1. inversion H1.
    inverts H0.
    right. left.
    inverts Typ1.
    exists* (e_ann (e_ann (open_exp_wrt_exp e (e_ann p A1)) B0) B).
   * destruct H0.
   ...
   { destruct H0. destruct H0.
     ...
     apply int_sub_arrow_false in H2. inversion H2.
     inverts H3.
     right. left.
