...
Static types, on the other hand, are needed to ensure type preservation
...
\noindent if the result of the expression would simply be $[[1]]$, then some
...
In other words, the original type would not be preserved. Instead we
would get a \emph{subtype}. This phenomenon is ofcourse well-known
