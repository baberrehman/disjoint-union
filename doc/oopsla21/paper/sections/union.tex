...
\subsubsection*{Values, pre-values and annotated values}
...
\subsubsection*{Bottom-Like Types}
...
\subsubsection*{Declarative Disjointness}
Now we present
...
\bruno{Perhaps this paragraph can be discussed in the overview?}
\subsubsection*{The role of type annotations}
