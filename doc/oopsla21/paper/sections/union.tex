...
\begin{figure}[t]
  ...
  \caption{Syntax and Algorithmic Subtyping for \cal. \snow{We need to add C as
      a metavariable for types here because it is used later} }
  \label{fig:union:syntax}
\end{figure}
\bruno{Add the syntax for the bi-directional modes in the Figure.}
...
\begin{figure}
  ...
  \caption{Updated disjointness and ordinary types for \cal.
    ...
    unless we are going to exceed the page limit.} }
  \label{fig:union:ord}
\end{figure}
