...
In the above example, \lstline{x} can be either a string or an integer,
...
The following example demonstrate how to define a function \lstline{padLeft}.
...
for the \lstline{padLeft} function: one add a string to the left of \lstline{v},
the other calls function \lstline{space} to generate an string of \lstline{x} spaces,
and then pad it to of \lstline{v}.
Although statically \lstline{x} has type \lstline{String|Integer}, as a concrete value 
