...
Consider a scenario where we are looking for a term that is assignable
to a given type that is not top-like. If all candidates' types are disjoint
based on this definition, at most one term can be chosen from them.
...
\subsubsection*{Annotatted Values}
