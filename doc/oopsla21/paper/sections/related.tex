...
\baber{They both did not define dynamic semantics. I think I am not using appropriate
wording. What I want to say here is that their typing elimination rule for union
is unrestricted.}
...
\baber{Again, I refer to typing elimination rule for union types.
They targeted preservation for union elimination with two approaches.
Also, their approach is different from ours.}
...
in target language.
She also studied merge operator in her calculus. We do not have merge operator
in \cal. Non-deterministic operational semantics for source language.
Incoherent calculus. Enforce restriction on expression to be substituted
...
She does not have case expression in source language.
Case in target language uses explicit tagging. \baber{need to polish Dunfield work.}
