...
\Cref{sec:inter}. Distributivity is trivial to add in \cal presented in \Cref{sec:union} and
...
This subtyping relation is not syntax directed. It has axioms for subtyping reflexivity (\rref{ds-refl}) and
