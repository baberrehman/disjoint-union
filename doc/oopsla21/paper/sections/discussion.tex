...
distributive subtyping relation that is based on the B+ logic~\cite{?}\bruno{ask Snow about this reference?}.
Distributive subtyping is more expressive and accomodates more programs than what we discussed in
\Cref{sec:inter}. Here we add distributive subtyping in the variant of \cal with
intersection types. 
