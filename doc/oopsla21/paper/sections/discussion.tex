...
loss of expressiveness. It is trivial to prove a lemma which says that $[[Bot]]$ type is
...
\ningning{I think this part is actually important. When we say Ceylon doesn't
  study the feature formally, we should also point out whether our formal study
  fits the Ceylon implementation or how it differs. So I would say we should
  keep this section.}
