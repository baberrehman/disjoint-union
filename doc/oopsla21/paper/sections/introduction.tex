...
In such languages a union type $[[A \/ B]]$ denotes values which can have type
...
consider what todo in situations where overlapping types arise.  A
...
not ambigous, can be modelled using union types and disjoint switches.
...
The work by \cite{} is the only work that we are aware of,
...
for intersection types~\cite{}. That line of work studies calculi
with intersection types and a merge operator. Disjointness
...
types to \cal. This extension is interesting because it reveals
...
types and distributive subtyping. All the extensions retain
