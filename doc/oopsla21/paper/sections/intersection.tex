...
\bruno{comparison with existing disjoitness definitions in this section.}
...
\baber{Need to restate type safety lemmas and discuss challenges involved.}
...
\begin{figure}[t]
  ...
  \medskip
    \begin{small}
    \centering
    \drules[s]{$ [[A <: B ]] $}{Algorithmic Subtyping \snow{extension?}\baber{I added "Additional" word in the caption. Does that seems fine or should we add extension/additional here?} }{anda, andb, andc}
  \end{small}
  \medskip
    \begin{small}
    \centering
