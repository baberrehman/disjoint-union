...
However we do not adopt this solution here two reasons:
...
\item Additionaly, the assumption that intersections of disjoint types
  are equivalent to bottom is too strong for some calculi with intersection
...
For those reason we adopt a different approach in \name.
