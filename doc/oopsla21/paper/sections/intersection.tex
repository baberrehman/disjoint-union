...
we have already discussed and shown their form in \Cref{sec:union:safety}.
...
and transitive.
\bruno{If there is space in the end we can state the lemmas}
...
\Cref{def:union:disj1}. However, while the \Cref{def:union:disj1} in Section~\ref{}
